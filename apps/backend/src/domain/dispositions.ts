...
// Lives in disposition-state.ts (completion.ts needs it too, and importing this
// module there would be circular); re-exported so import sites are unchanged.
export { deriveDisposition }
